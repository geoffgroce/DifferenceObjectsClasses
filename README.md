...
**Objects:**
<br>An object derives from within a class. Per Horstmann, the definition of an object is that it is a “value of a class type” (Horstman, p. G-1). The object itself is a representation of a usable entity with an actual value. For instance:<br />
